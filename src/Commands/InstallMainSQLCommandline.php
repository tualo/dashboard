<?php
namespace Tualo\Office\Dashboard\Commands;
use Garden\Cli\Cli;
use Garden\Cli\Args;
...
class InstallMainSQLCommandline implements ICommandline{
    ...
    public static function getCommandName():string { return 'install-sql-dashboard';}

    public static function setup(Cli $cli){
        $cli->command(self::getCommandName())
            ->description('installs needed sql for dashboard module')
    ...
    public static function run(Args $args){
        ...
        $files = [
            'install/dashboard_available_types'    => 'setup dashboard_available_types',
            'install/dashboard_available_types.ds'    => 'setup dashboard_available_types.ds',
            
            'install/dashboard'    => 'setup dashboard',
            'install/dashboard.ds'    => 'setup dashboard.ds',
        ];
